...
#ADDING SURFACES TO THE STRAT PILE
    ...
    mod_dict[mod_id].add_prop(por_sand)
    mod_dict[mod_id].add_prop(hyd_con)
    mod_dict[mod_id].add_prop(hyd_con_clay)
...
#get the 2D porosity array
por_facies1=por_facies1[0,0,0,:,0,:]
comp_facies1 = np.full_like(por_facies1, por_facies1)  # Initialize a 2D array
comp_coeff=-0.0005
#make depth array
